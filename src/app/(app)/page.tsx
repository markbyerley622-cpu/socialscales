...
import { Card, CardHeader, EmptyState, ProjectDot } from "@/components/ui/primitives";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link href="/content" className={buttonClass("primary", "md")}>
            <UploadCloud />
            Upload content
          </Link>
        }
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader
                ...
                action={
                  <Link href="/activity" className={buttonClass("ghost", "sm")}>
                    Full log
                    <ArrowUpRight />
                  </Link>
                }
