...
export async function generateMetadata(
  props: PageProps<"/ops/content/[assetId]">,
): Promise<Metadata> {
...
export default async function AssetPage(props: PageProps<"/ops/content/[assetId]">) {
  const { assetId } = await props.params;
    ...
    <>
      <PageHeader
        ...
        actions={
          <>
            <Link
              href={`/ops/content?project=${asset.project.slug}`}
