...
export default async function AppLayout({
  ...
  return (
    // `ops-theme` re-points the six design tokens the console and the product
    // dashboard share. Every Tailwind utility inside this tree resolves to the
    // console's violet palette; outside it, to the dashboard's cyan one.
    <div className="ops-theme flex min-h-dvh">
      <aside className="sticky top-0 hidden h-dvh w-[13.5rem] shrink-0 flex-col border-r border-hairline bg-plane/80 backdrop-blur md:flex">
        <div className="flex h-12 items-center gap-2 border-b border-hairline px-4">
          ...
          <Link
            href="/dashboard"
            className="text-[11.5px] font-semibold tracking-[0.16em] text-ink"
            title="Back to the Social Scales dashboard"
          >
            OPS CONSOLE
          </Link>
        </div>
