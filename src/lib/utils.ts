...
// ---------------------------------------------------------------------------
// Social Scales dashboard formatters
//
// Kept alongside the console's own helpers rather than merged into them: the
// two surfaces format the same quantities differently on purpose (the console
// shows exact figures, the dashboard shows rounded ones), and collapsing them
